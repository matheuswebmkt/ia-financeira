      ...
      <div className="container mx-auto flex max-w-2xl flex-col items-center gap-6 px-5 text-center">
        ...
        <AnimateOnScroll delay={0.1}>
          ...
          <h4 className={cn("text-lg font-semibold leading-relaxed text-foreground")}>
            Um plano interativo com inteligência artificial que cria um caminho claro, prático e possível pra sair do sufoco.
          </h4>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll delay={0.2}>
          ...
          <p className={cn("text-base leading-relaxed text-muted-foreground")}>
            Quem domina isso agora, <span className="font-semibold text-foreground">sai na frente</span>.
          </p>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll delay={0.3}>
           ...
           <ShinyButton02 text="Quero sair na frente com IA" />
        </AnimateOnScroll>
